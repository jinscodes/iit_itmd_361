...
2. Use the _index.html_ file and the _images_ folder to create your lab repository. Include the images inside the folder.
3. You are tasked with cleaning up the _index.html_ file so that it looks (almost) exactly like the _lab4_final.html_ file. Your alt tags should be the only difference.
...
8. **Improtant Validation Issues:** The html validation of a perfect lab 4 will still produce one warning and one error.
